      ...
      <div className="fixed top-0 left-0 w-full bg-black/10 backdrop-blur-md z-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between py-3">
            ...
            <motion.a href="/" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }} viewport={{ once: true }} className="relative inline-block px-6 py-2 font-medium text-white border border-white/20 rounded-[4px] overflow-hidden group">
